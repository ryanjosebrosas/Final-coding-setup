---
name: code-reviewer
description: Runs a comprehensive code review covering security, types, architecture, and quality.
             Use when /code-review needs deep analysis. Trigger phrases: "review the code",
             "run code review", "deep code review", "check for bugs", "security review",
             "review these changes", "analyze code quality".
model: sonnet
---
