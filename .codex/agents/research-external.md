...
description: Fetches and summarises external documentation, library APIs, and best practices.
             Use during /planning when external docs are needed. Trigger phrases: "look up docs",
             "find documentation for", "research library API", "check best practices for",
             "fetch external docs", "what does the docs say about", "research {library}".
model: haiku
---
