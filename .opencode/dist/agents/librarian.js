...
// AGENT METADATA
// ============================================================================
export const LIBRARIAN_METADATA = AGENT_REGISTRY["librarian"];
// ============================================================================
// PROMPT BUILDER
// ============================================================================
/**
 ...
 */
function buildLibrarianApproachSteps() {
    const steps = [
 ...
 */
export function createLibrarianPrompt(context) {
    ...
    const systemPrompt = buildLibrarianSystemPrompt(metadata, roleContext, approachSteps, sourcePriority, outputFormat, queryOptimization);
    return {
        systemPrompt,
        skillsPrompt: "",
 ...
 */
function buildLibrarianSystemPrompt(metadata, roleContext, approachSteps, sourcePriority, outputFormat, queryOptimization) {
 ...
 */
function buildQueryOptimization() {
...
export function createLibrarianAgent(model) {
    ...
    return {
        name: metadata.name,
        instructions: buildLibrarianSystemPrompt(metadata, buildRoleContext(), buildLibrarianApproachSteps(), buildSourcePriority(), buildOutputFormat(), buildQueryOptimization()),
        model,
