 ...
 */
export function getAgentSummary(agentName) {
 ...
 */
export function getExecutionAgentSummaries() {
    return Object.values(SUMMARIES).filter(s => !s.readOnly);
}
/**
 * Get summaries for read-only consultation agents.
 */
export function getConsultationAgentSummaries() {
    return Object.values(SUMMARIES).filter(s => s.readOnly);
}
/**
 * Format summaries for prompt inclusion.
 */
export function formatAgentSummariesForPrompt(agents) {
 ...
 */
export function getAgentOneLiners() {
    const oneLiners = {};
...
//# sourceMappingURL=available-agents.js.map