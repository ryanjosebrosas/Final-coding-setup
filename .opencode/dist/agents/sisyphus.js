...
import { buildSystemPrompt, buildRules, buildDecisionTree, } from "./prompt-builder";
// ============================================================================
// AGENT METADATA
// ============================================================================
export const SISYPHUS_METADATA = AGENT_REGISTRY["sisyphus"];
// ============================================================================
// PROMPT BUILDER
// ============================================================================
/**
 ...
 */
function buildSisyphusApproachSteps() {
    const steps = [
 ...
 */
export function createSisyphusPrompt(context) {
 ...
 */
function buildSisyphusSystemPrompt(metadata, roleContext, approachSteps, delegationRules) {
 ...
 */
export function createSisyphusAgent(model) {
    const metadata = SISYPHUS_METADATA;
    return {
        name: metadata.name,
        instructions: buildSisyphusSystemPrompt(metadata, buildRoleContext(), buildSisyphusApproachSteps(), buildDelegationRules()),
        model,
