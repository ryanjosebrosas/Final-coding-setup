 ...
 */
export function applyGeminiOverlayToSisyphus(config) {
    return {
        ...config,
 ...
 */
export function applyGeminiOverlayToHephaestus(config) {
    return {
        ...config,
        instructions: config.instructions + `
 ...
 */
export function applyGeminiOverlayToOracle(config) {
    return {
        ...config,
        instructions: config.instructions + `
 ...
 */
export function applyGeminiOverlayToMomus(config) {
    return {
        ...config,
        instructions: config.instructions + `
 ...
 */
export function applyGeminiOverlay(agentName, config) {
 ...
 */
export function applyGPTOverlay(agentName, config) {
...
//# sourceMappingURL=gemini-overlays.js.map