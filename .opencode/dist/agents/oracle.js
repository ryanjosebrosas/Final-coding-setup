...
// AGENT METADATA
// ============================================================================
export const ORACLE_METADATA = AGENT_REGISTRY["oracle"];
// ============================================================================
// PROMPT BUILDER
// ============================================================================
/**
 ...
 */
function buildOracleApproachSteps() {
    const steps = [
 ...
 */
export function createOraclePrompt(context) {
 ...
 */
function buildOracleSystemPrompt(metadata, roleContext, approachSteps, outputFormat) {
 ...
 */
function buildOracleOutputFormat() {
...
export function createOracleAgent(model) {
    ...
    return {
        name: metadata.name,
        instructions: buildOracleSystemPrompt(metadata, buildRoleContext(), buildOracleApproachSteps(), buildOracleOutputFormat()),
        model,
