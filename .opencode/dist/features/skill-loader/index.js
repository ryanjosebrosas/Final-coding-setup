 ...
 */
function parseSkillFile(content, name, path) {
 ...
 */
export function getSkillContentForPrompt(skillNames) {
 ...
 */
export function buildCategorySkillPrompt(categoryPrompt, skillNames) {
