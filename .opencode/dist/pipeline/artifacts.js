 ...
 */
export function discoverArtifacts(workspaceDir, feature) {
    ...
    try {
        ...
        for (const file of files) {
            ...
            if (!file.name.endsWith(".md") && !file.name.endsWith(".done.md"))
                continue;
 ...
 */
export function getPendingArtifacts(artifacts) {
    return artifacts.filter(a => a.status === "pending");
}
/**
 * Get completed artifacts (status: "done").
 */
export function getDoneArtifacts(artifacts) {
 ...
 */
export function markArtifactDone(workspaceDir, artifact) {
 ...
 * Returns true if successful, false otherwise.
 */
export function markArtifactPending(workspaceDir, artifact) {
 ...
 */
export function getNextPendingTask(artifacts) {
 ...
 */
function parseArtifactName(filename, feature, _workspaceDir) {
 ...
 */
export function getArtifactDiscoveryResult(workspaceDir, feature) {
 ...
 */
export function isPhaseComplete(workspaceDir, feature, requiredArtifacts) {
    const artifacts = discoverArtifacts(workspaceDir, feature);
 ...
 */
export function getHighestTaskNumber(artifacts) {
 ...
 */
export function getNextPhaseNumber(artifacts) {
 ...
 */
export function findFirstIncompleteArtifact(workspaceDir, feature) {
    ...
    if (planMasterPending)
        return planMasterPending;
    // Then tasks in order
    if (result.nextTask)
