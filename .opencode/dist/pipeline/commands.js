 ...
 */
export function loadCommand(commandName, workspaceDir) {
 ...
 */
export function listCommands(workspaceDir) {
    const commands = [];
 ...
 */
export function getCommandsForStatus(status) {
    const commands = [];
 ...
 */
export function suggestNextCommand(status, feature) {
    const suggestions = {
