...
Create `.claude/skills/code-review/SKILL.md` — a knowledge framework for code review quality:
severity classification criteria, evidence standards, completeness, and what makes a
review actionable vs. decorative.

## Scope

- **File to create**: `.claude/skills/code-review/SKILL.md`
- **Out of scope**: Do NOT modify `.claude/commands/code-review.md`
- **Dependencies**: None

## Prior Task Context

Tasks 1-5 complete. Pattern stable. Task 6 begins the quality/review phase skills.

## Context References

### Reference: .claude/commands/code-review.md (key sections)
...
## Step 3: Review — Three Severity Levels
...
## Output Format
CODE REVIEW: {scope}
Critical (blocks commit): `{file:line}` — {issue} / Why: {explanation} / Fix: {suggestion}
Major (fix soon): same format
Minor (consider): same format
...
### IMPLEMENT: Create `.claude/skills/code-review/SKILL.md`
...
```bash
grep -c "name: code-review" .claude/skills/code-review/SKILL.md
grep -c "When This Skill Applies" .claude/skills/code-review/SKILL.md
grep -c "Key Rules" .claude/skills/code-review/SKILL.md
grep -c "Anti-Patterns" .claude/skills/code-review/SKILL.md
```
...
# L1
grep -c "name: code-review" .claude/skills/code-review/SKILL.md
grep -c "compatibility: claude-code" .claude/skills/code-review/SKILL.md
grep -c "When This Skill Applies" .claude/skills/code-review/SKILL.md
grep -c "Key Rules" .claude/skills/code-review/SKILL.md
# L2-L5: N/A
```
...
- [ ] Covers Critical/Major/Minor classification criteria with examples
- [ ] Covers evidence standards (file:line, why, specific fix)
- [ ] Covers full-file-not-just-diff rule
- [ ] Has Anti-Patterns and Key Rules sections

## Handoff Notes

Task 7 creates `.claude/skills/code-review-fix/SKILL.md`. Focus: minimal change principle,
severity ordering rationale, verification after each fix, scope discipline.
